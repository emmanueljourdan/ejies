...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 407.0, 372.0, 166.0, 19.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 423.0, 341.0, 119.0, 21.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 428.0, 178.0, 119.0, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 428.0, 34.0, 56.0, 21.0 ],
									"style" : "",
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 428.0, 63.0, 107.0, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 158.0, 97.0, 41.0, 21.0 ],
									"style" : "",
									"text" : "active"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 135.0, 97.0, 20.0, 20.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 135.0, 121.0, 63.0, 21.0 ],
									"style" : "",
									"text" : "metro 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 11.0, 17.0, 68.0, 21.0 ],
									"style" : "",
									"text" : "loadmess 2"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 11.0, 62.0, 104.0, 21.0 ],
									"pattrmode" : 1,
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 11.0, 89.0, 50.0, 21.0 ],
									"style" : "",
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 11.0, 114.0, 86.0, 21.0 ],
									"style" : "",
									"text" : "outputmode $1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 4,
									"numoutlets" : 0,
									"patching_rect" : [ 284.0, 104.0, 210.0, 21.0 ],
									"style" : "",
									"text" : "bgcolor 0.937255 0.92549 0.792157 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "list", "" ],
									"patching_rect" : [ 119.0, 159.0, 303.0, 21.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 42.0, 79.0, 19.0 ],
									"style" : "",
									"text" : "output modes"
								}
...
,
					"patching_rect" : [ 423.0, 318.0, 119.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
,
					"patching_rect" : [ 423.0, 295.0, 119.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
,
					"patching_rect" : [ 423.0, 272.0, 119.0, 21.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 208.0, 82.0, 100.0, 19.0 ],
					"style" : "",
					"text" : "draw something..."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 276.0, 211.0, 100.0, 19.0 ],
					"style" : "",
					"text" : "proba"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 274.0, 231.0, 50.0, 21.0 ],
					"presentation_rect" : [ 0.0, 0.0, 50.0, 18.0 ],
					"style" : "",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 323.0, 231.0, 19.0, 19.0 ],
					"style" : "",
					"text" : "%"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 191.0, 211.0, 73.0, 19.0 ],
					"style" : "",
					"text" : "random step"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.5, 309.0, 61.0, 21.0 ],
					"style" : "",
					"text" : "pvar multi"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 197.0, 231.0, 50.0, 21.0 ],
					"presentation_rect" : [ 0.0, 0.0, 50.0, 18.0 ],
					"style" : "",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "int" ],
					"patching_rect" : [ 89.0, 284.0, 102.0, 21.0 ],
					"style" : "",
					"text" : "t 1 l 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 89.0, 222.0, 63.0, 21.0 ],
					"style" : "",
					"text" : "metro 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.0, 334.0, 61.0, 21.0 ],
					"style" : "",
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 310.0, 102.0, 19.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.0, 191.0, 172.0, 71.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "list", "" ],
					"patching_rect" : [ 89.0, 262.0, 181.0, 21.0 ],
					"style" : "",
